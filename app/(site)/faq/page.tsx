...
export const metadata: Metadata = { title: "Najczęstsze pytania (FAQ)", description: "Odpowiedzi na pytania o tworzenie stron i sklepów internetowych: terminy, materiały, płatność, hosting i wsparcie po wdrożeniu.", alternates: canonical("/faq") };
