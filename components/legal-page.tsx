...
export function LegalPage({ eyebrow, title, intro, updated = "22 czerwca 2026", children }: { eyebrow: string; title: string; intro: string; updated?: string; children: ReactNode }) {
