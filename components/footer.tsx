    ...
    <footer className="bg-ink text-white">
      <div className="container-page py-16 md:py-20">
        <div className="grid gap-12 border-b border-white/12 pb-14 lg:grid-cols-[1.6fr_1fr_1fr]">
          <div><p className="font-serif text-3xl tracking-wide">BRAIDED <span className="text-brass-light">DIGITAL</span></p><p className="mt-5 max-w-md text-sm leading-7 text-white/55">Projektuję i wdrażam strony dla małych firm. Rozmawiasz bezpośrednio ze mną, od pierwszej wiadomości do publikacji.</p><p className="mt-5 text-xs text-white/35">Marek Białkowski</p><div className="mt-7 flex flex-col items-start gap-2"><a href="https://wa.me/48730195530" target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 text-sm text-brass-light"><WhatsAppIcon className="size-5" /> +48 730 195 530</a><a href="mailto:ma.atelier.kontakt@gmail.com" className="text-xs text-white/55 transition hover:text-white">ma.atelier.kontakt@gmail.com</a><p className="text-xs text-white/35">Chylin 35, 62-710 Władysławów</p></div></div>
          ...
          <div><p className="mb-5 text-[.65rem] font-bold uppercase tracking-[.2em] text-brass-light">Zacznijmy</p><Link href="/kontakt" className="group flex items-center justify-between border-b border-white/20 pb-3 font-serif text-2xl">Napisz kilka zdań <Arrow className="size-5 transition group-hover:translate-x-1" /></Link><Link href="/wycena" className="mt-5 block text-xs text-white/45 transition hover:text-white">Lub policz orientacyjny budżet online</Link></div>
        </div>
