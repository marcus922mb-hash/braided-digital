/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/ai/wrangler.jsonc workers/ai/worker-configuration.d.ts` (hash: 32e90e5b5858f4b8c666a23dbd38553f)
// Runtime types generated with workerd@1.20260625.1 2026-06-28 
interface __BaseEnv_Env {
	AI: Ai;
	ENVIRONMENT: "production";
	DEFAULT_MODEL: "@cf/meta/llama-3.1-8b-instruct";
	ALLOWED_MODELS: "@cf/meta/llama-3.3-70b-instruct-fp8-fast,@cf/meta/llama-3.1-70b-instruct,@cf/meta/llama-3.1-8b-instruct,@cf/mistral/mistral-7b-instruct-v0.2";
}
